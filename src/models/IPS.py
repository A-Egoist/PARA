...
class IPS(nn.Module):
    def __init__(self, backbone, device, num_users, num_items, embedding_dim, n_layers, item_popularity, method_config, graph=None):
        ...
        self.ips_lambda = method_config['ips_lambda']  # ips_lambda
    ...
    def forward(self, user_indices, item_i_indices, item_j_indices):
        ...
        ips_c = torch.minimum(1 / item_i_popularity, torch.tensor(self.ips_lambda)) / self.ips_lambda
        return prediction_i, prediction_j, ips_c, reg_loss
